...
Label(window, text="Credit").place(x=20, y=260)
...
Entry(window, textvariable=credit).place(x=130, y=260)
...
#Table
table = ttk.Treeview(window, height=21, columns=["ID", "Name", "Family", "Phone Number", "Enroll Date", "Class", "Credit", "Teacher"], show="headings")

table.column("ID", width=50)
table.column("Name", width=120)
table.column("Family", width=120)
table.column("Phone Number", width=140)
table.column("Enroll Date", width=100)
table.column("Class", width=100)
table.column("Credit", width=60)
...
table.heading("Credit", text="Credit")
